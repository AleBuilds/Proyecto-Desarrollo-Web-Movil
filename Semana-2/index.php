    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            <div class="container-fluid"> 
                <a class="navbar-brand" href="index.php"><i class="material-icons">star_border</i></a>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Marca de Ropa</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="marcaderopa.php">Quienes Somos</a></li>
        ...
        <div class="container-fluid bg-warning">
            <a href="marcaderopa.php">Ir a Marca de Ropa</a><br>
